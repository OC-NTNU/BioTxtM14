...
The primary goal of the annotation is not to analyse the text according to some linguistic formalism or theory, or following some knowledge representation formalism or ontological theory.
Instead the goal of the annotation is rather pragmatic: to serve as an intermediary step in the process of extracting rules about the relation between quantitative variables from raw text.      
