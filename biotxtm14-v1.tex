...
It is an iterative procedure, starting with a small amount of labeled data and a large amount of unlabeled data.
In each iteration, a classifier is trained on the labeled data and subsequently applied to the unlabeled data.
The most informative instances -- e.g., those for which classification confidence is lowests -- are passed on to a human annotator for manual annotation.
